...
pickle.dump(lin_reg, open(os.path.join(os.getcwd(),'..','notebooks', "linear_model"), "wb"))
...
pickle.dump(tree_reg, open(os.path.join(os.getcwd(),'..','notebooks', "decisiontree_model"), "wb"))
...
pickle.dump(final_model, open(os.path.join(os.getcwd(),'..','notebooks', "randomforest_model"), "wb"))
